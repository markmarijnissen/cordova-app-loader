...
1. Write a manifest.json to describe the files of your app.
2. Upload the manifest and files to a server
3. Let `CordovaAppLoader` check the new manifest, download files and update your app!
